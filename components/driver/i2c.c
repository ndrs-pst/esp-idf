...
esp_err_t i2c_master_write(i2c_cmd_handle_t cmd_handle, uint8_t const* data, size_t data_len, bool ack_en)
{
    ...
    while (data_len > 0) {
        ...
        cmd.data = (uint8_t*)((intptr_t)data + data_offset);  /* ES1902-003 */
